        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Classifications_ObjectId", x => x.ObjectId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Manufacturers_ObjectId", x => x.ObjectId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Sales_ObjectId", x => x.ObjectId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Suppliers_ObjectId", x => x.ObjectId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Units_ObjectId", x => x.ObjectId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Parts_ObjectId", x => x.ObjectId);
                    table.ForeignKey(
                        name: "FK_Parts_Classifications_ClassificationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartNumber = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Inventories_ObjectId", x => x.ObjectId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_InventoryItems_ObjectId", x => x.ObjectId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_SaleItems_ObjectId", x => x.ObjectId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Parts_ClassificationId",
                table: "Parts",
